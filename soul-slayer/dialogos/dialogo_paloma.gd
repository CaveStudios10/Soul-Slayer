...
var dialog_data = [
	...
	{"name": "Gregory", "dialog": "Hey forasteiro, eu sou Gregory. Sou o Vigia do Touro junto com a Paloma. Diga Oi Paloma.", "faceset": "res://assets/dialogos/gregory-cabeca-pixilart.png"},
	{"name": "Gregory", "dialog": "IIhhh Hiiii hii!!!.", "faceset": "res://assets/dialogos/Gregory.png"},
	{"name": "Gregory", "dialog": "Boa Sorte contra esse Touro. Só não vá morrer no Pakour a frente. Boa sorte!!.", "faceset": "res://assets/dialogos/gregory-cabeca-pixilart.png"},
]
